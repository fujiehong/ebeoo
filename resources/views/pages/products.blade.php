    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-4 col-xs-12">
                <a href="#" class="block">
                    <div class="feature feature-1">
                        <img alt="Image" src="/images/smart-cubes/whacky-wheels-kit.png" />
                        <div class="feature__body boxed boxed--border">
            ...
            <div class="col-sm-4 col-xs-12">
                <a href="#" class="block">
                    <div class="feature feature-1">
                        <img alt="Image" src="/images/smart-cubes/bright-lights-kit.png" />
                        <div class="feature__body boxed boxed--border">
            ...
            <div class="col-sm-4 col-xs-12">
                <a href="#" class="block">
                    <div class="feature feature-1">
                        <img alt="Image" src="/images/smart-cubes/smart-art-kit.png" />
                        <div class="feature__body boxed boxed--border">

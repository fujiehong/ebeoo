            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <ol class=" breadcrumbs">
                        <li>
                            <a class="type--uppercase" href="{{route('sbb')}}"">home</a>
                        </li>
                        <li>
                            <a class="type--uppercase" href="#">collections</a>
                        </li>
                        <li class="type--uppercase">
                            <a class="type--uppercase" href="{{route('collections',[$productCategory->id])}}">{{$productCategory->name}}</a>
                        </li>
                        <li class="type--uppercase">{{$product->title}}</li>
                    </ol>
    ...
    <section>
        <div class="container">
            <div class="row">
                ...
                @include('sbb.products._product_related_list', ['products' => $products])
            </div>
            <!--end of row-->
        </div>
        <!--end of container-->
